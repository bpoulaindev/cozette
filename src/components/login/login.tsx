...
export const Login = () => {
  ...
  return (
    <View style={tailwind('flex flex-col h-full items-center z-50 w-full bg-slate-100')}>
      ...
      />
      <AppText style={tailwind('text-3xl font-normal text-center mt-10')} font='SuperiorBold'>
        Prêt à découvrir Lille ?
      </AppText>
      <View style={tailwind('mt-16 max-w-[75%] w-full flex flex-col')}>
        ...
        <View style={tailwind('mt-10 w-full')}>
        ...
        <View style={tailwind('w-full flex justify-end items-end')}>
          <SimpleButton
            variant='text'
            contentClasses='text-primary-300 text-base'
